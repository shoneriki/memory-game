        ...
        <div className="explanation">
          ...
          />
          {
            ...
            <div className="explanationTxt">
              <p>
                Click each character card once, if you click on the character again, you lose the game. The goal is to click on all the characters without clicking on the same character twice. There are 18 cards in all
              </p>
            </div>
            )
          }
